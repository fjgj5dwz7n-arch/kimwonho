...
- 프로필, 이름, 이메일: `src/data/site.ts`
- 작품 목록: `src/data/works.ts`
- 이력 목록: `src/data/cv.ts`
- 연구 프로젝트: `src/data/research.ts`
- 아카이브: `src/data/archive.ts`
