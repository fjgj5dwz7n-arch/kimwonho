...
export const cvSections: CvSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail: "시와 산문, 웹 공개작을 발표했습니다.",
      },
      {
        year: "2023",
        title: "윤동주시문학상, 가람이병기청년시문학상 등",
        organization: "문학상",
        detail: "시 부문 수상 및 선정 기록.",
      },
      {
        year: "2024",
        title: "《자음과모음》 2024 겨울",
